...
INSERT INTO `customer_ledger` (`customer_id`, `transaction_id`, `transaction_type`, `amount`, `payment_method`, `description`, `created_at`) VALUES
(1, NULL, 'credit_sale', 275000.00, NULL, 'Samsung Galaxy S23 Ultra - TXN20241227002', '2024-12-26 14:15:00'),
(1, NULL, 'payment', 100000.00, 'cash', 'Partial payment received', '2024-12-26 18:00:00'),
(1, NULL, 'payment', 50000.00, 'bank_transfer', 'Bank transfer payment', '2024-12-27 10:00:00'),
(1, NULL, 'payment', 110000.00, 'cash', 'Final payment received', '2024-12-27 14:00:00');

-- Customer 3 (Hassan Raza) - Partial payment
INSERT INTO `customer_ledger` (`customer_id`, `transaction_id`, `transaction_type`, `amount`, `payment_method`, `description`, `created_at`) VALUES
(3, NULL, 'credit_sale', 195000.00, NULL, 'iPhone 14 - TXN20241227003', '2024-12-26 16:45:00'),
(3, NULL, 'payment', 170000.00, 'cash', 'Partial payment at time of sale', '2024-12-26 16:45:00');

-- Customer 5 (Bilal Ahmed) - Old balance
INSERT INTO `customer_ledger` (`customer_id`, `transaction_id`, `transaction_type`, `amount`, `payment_method`, `description`, `created_at`) VALUES
(5, NULL, 'credit_sale', 35000.00, NULL, 'Previous purchase - accessories', '2024-12-20 12:00:00'),
(5, NULL, 'payment', 30000.00, 'cash', 'Partial payment', '2024-12-22 15:00:00');

-- ============================================
-- 8. TRADE-INS (Old Phone Exchange)
-- ============================================

INSERT INTO `trade_ins` (`transaction_ref`, `customer_id`, `brand`, `model`, `imei`, `condition`, `value`, `notes`, `created_at`) VALUES
('TXN20241227002', 1, 'Samsung', 'Galaxy S21', '351111111111111', 'good', 85000.00, 'Screen minor scratches, battery 85%', '2024-12-26 14:15:00'),
('TXN20241227003', 3, 'iPhone', 'iPhone 11', '352222222222222', 'fair', 65000.00, 'Back glass cracked, working fine', '2024-12-26 16:45:00');
